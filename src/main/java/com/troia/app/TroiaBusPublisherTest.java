...
public class TroiaBusPublisherTest {
	public static void main(String[] args) throws Exception {

		BusManager bus = new BusManager();
		bus.register("kafka1", new KafkaConnector("localhost:9092", "troia-service", "troia-group"), BusRole.PUBLISHER);
		bus.register("redpanda1", new RedpandaConnector("localhost:19092", "troia-service", "troia-group"), BusRole.PUBLISHER);
		bus.register("rabbit1", new RabbitConnector("localhost", 5672, "guest", "guest", "/", "troia-service"), BusRole.PUBLISHER);
		bus.register("rabbit2", new RabbitConnector("localhost", 5672, "guest", "guest", "/", "troia-service"), BusRole.PUBLISHER);
